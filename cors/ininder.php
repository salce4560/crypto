...
<body>
    <div class="container">
        ...
        <form id="myForm" action="https://data.ntpc.gov.tw/api/datasets/4A03827A-588B-4058-AB21-EC02283E2BB7/json?page=0&size=100" method="post">
...
<button id="myBtn" type="button" class="getdate">button</button>
    ...
    $(document).ready(function() {
        ...
        $('#myBtn').submit(function(e) {            
            // var form = $(this);
            var url='http://localhost/cors/getApi.php'
            $.ajax({
                type: "post",
                url: url,
                 dataType  : 'json',
